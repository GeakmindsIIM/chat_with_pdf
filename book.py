...
def main():
    st.set_page_config(page_title="Interactive PDF Query Tool", layout="wide")
    ...
    with st.sidebar:
        ...
        pdf_docs = st.file_uploader("Upload PDF files (6th to 12th standard)", accept_multiple_files=True, type="pdf")
